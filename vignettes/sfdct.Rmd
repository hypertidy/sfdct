...
plot(nc_triangles, col = viridisLite::viridis(nrow(nc_triangles)))
```
...
plot(nc1,col = viridisLite::viridis(nrow(nc1)))
...
plot(nc1_triangles, col = NA, border = bcol)

nc2_triangles <- ct_triangulate(nc1, a = min(st_area(st_set_crs(nc1, NA)))/25)
plot(nc2_triangles, col = NA, border = bcol)
